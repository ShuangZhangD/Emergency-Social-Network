...
suite('Post Announcement Unit Tests', function(){
    ...
    test('Testing Announcement Function', function(done){
        dboper.InsertAnnouncement("keqin", "testing announcement function in Unit Test", Date.now(), "Active", url, function (err, results1){
    ...
    test('Testing Announcement Function DB Error', function(done){
        dboper.InsertAnnouncement("keqin", "testing announcement function in Unit Test", Date.now(), "Active",error_url, function(err,result){
            //dboper.LoadAnnouncement(url, function (err, results2) {
    ...
    test('Test Public Chat Search Function in models', function(done){
        dboper.InsertAnnouncement("keqin", "testing announcement function in Unit Test", Date.now(), "Active",url, function(err0,content0){
